...
|---|---|---|
| [`edit-in-place/`](edit-in-place/) | Open a `.jdf`, double-click a line, type, press Enter (or click away) — the change is saved to the file. | `edit-in-place/edit-in-place.mp4` (1280×720, 17 s) |
