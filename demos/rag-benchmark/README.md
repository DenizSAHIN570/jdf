...
A 25-second presentation of the benchmark in [`bench/`](../../bench/): the setup (same 24 reports, two formats, same pipeline), retrieval accuracy per embedding model, the RAG cost comparison at 1,000 documents, and the one-paragraph re-index test.
