...
Generated 2026-09-12 on Apple M5 (macOS-26.6.2-arm64-arm-64bit-Mach-O, Python 3.14.6). Corpus: 24 documents / 120 pages / 192 questions (120 table-cell, 48 prose, 24 list). Reproduce: `pip install -r requirements.txt && python rag_bench.py` — see bench/README.md.
